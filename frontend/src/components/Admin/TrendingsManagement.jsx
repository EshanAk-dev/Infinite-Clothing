...
const TrendingsManagement = () => {
  ...
  // Apply filters to trending products
  ...
  const handleDelete = (id, name) => {
    openDeleteModal({
      title: "Delete Trending Product",
      message: "Are you sure you want to delete this trending product? This action cannot be undone.",
      itemName: name,
        ...
        <div className="flex flex-col items-center justify-center py-12">
          ...
          <p className="text-gray-400 text-center px-4">
            {nameFilter || skuFilter || categoryFilter
              ...
              : "Add your first trending product to get started"}
          </p>
        </div>
      );
    }
      ...
      >
        <div className="p-4 flex items-center">
          ...
          <div className="ml-4 flex-1">
            ...
            <div className="text-xs text-purple-700 mt-1">{product.sku}</div>
          </div>
    ...
    <div className="max-w-7xl mx-auto p-3 sm:p-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 w-full sm:w-auto justify-end">
          ...
          <Link
            to="/admin/trendings/new"
            className="flex items-center gap-2 bg-purple-600 hover:bg-purple-700 text-white px-5 py-2.5 rounded-lg shadow-md hover:shadow-lg transition-all duration-300 w-full sm:w-auto justify-center"
          >
