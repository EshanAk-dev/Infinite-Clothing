  ...
  if (!orderDetails) return (
    <div className="max-w-7xl mx-auto p-6">
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8 text-center">
        ...
        <h3 className="mt-4 text-lg font-medium text-gray-900">No order details found</h3>
        <p className="mt-1 text-gray-500">The order you're looking for doesn't exist</p>
        <Link to="/admin/orders" className="mt-4 inline-block px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors">
          Back to Orders
        </Link>
      </div>
    </div>
          ...
          <div className="flex flex-col sm:flex-row justify-between">
            <div>
              <h3 className="text-lg font-semibold text-gray-800">
                Order <span className="font-mono text-blue-600">#{orderDetails._id.slice(-8).toUpperCase()}</span>
              </h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-6 border-b border-gray-200">
          <div className="bg-gray-50 p-4 rounded-lg">
            ...
            <div className="space-y-2">
              <p className="text-sm"><span className="font-medium text-gray-700">Name:</span> {orderDetails.user?.name || 'N/A'}</p>
              <p className="text-sm"><span className="font-medium text-gray-700">Email:</span> {orderDetails.user?.email || 'N/A'}</p>
              <p className="text-sm"><span className="font-medium text-gray-700">Phone:</span> {orderDetails.shippingAddress?.phone || 'N/A'}</p>
            </div>
          </div>
          ...
          <div className="bg-gray-50 p-4 rounded-lg">
            ...
            <div className="space-y-2">
              <p className="text-sm"><span className="font-medium text-gray-700">Method:</span> {orderDetails.shippingMethod || 'Standard Shipping'}</p>
              <p className="text-sm"><span className="font-medium text-gray-700">Address:</span> {`
          ...
          <div className="bg-gray-50 p-4 rounded-lg">
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <p className="text-sm mt-1">{orderDetails.paymentMethod || 'N/A'}</p>
              </div>
              <div>
                  ...
                  <tr key={item.productId} className="hover:bg-gray-50 transition-colors">
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        ...
                        <div className="ml-4">
                          <Link to={`/product/${item.productId}`} className="text-sm font-medium text-blue-600 hover:text-blue-800">
                            {item.name}
                          </Link>
                          {item.color && (
