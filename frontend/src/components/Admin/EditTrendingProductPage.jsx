...
const EditTrendingProductPage = () => {
  ...
  }, [dispatch, trendingProducts.length]);

  // Find the trending product by id
  useEffect(() => {
    if (id && trendingProducts.length) {
      const prod = trendingProducts.find((p) => p._id === id);
      if (prod) {
        setProductData({
          ...prod,
  ...
  const handleSubmit = (e) => {
    ...
    dispatch(updateProduct({ id, productData }))
      ...
      .catch((err) => {
        toast.error("Failed to update trending product!", {
          style: {
            background: "#fef2f2",
            color: "#b91c1c",
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <span className="text-xs text-purple-600">
                        This product is marked as trending
                      </span>
                    </div>
                  </div>
                </div>
...
export default EditTrendingProductPage;
