  ...
  return (
    <footer className="border-t py-12">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4 lg:px-0">
        <div>
          <h3 className="text-lg text-gray-800 mb-4 ml-5">Newsletter</h3>
          <p className="text-gray-500 mb-4 ml-5">
            Be the first to hear about our new products, exclusive offers and
            new offers.
          </p>
          <p className="font-medium text-sm text-gray-600 mb-6 ml-5">
      ...
      <div className="container mx-auto mt-12 px-4 lg:px-0 border-t border-gray-200 pt-6">
        ...
        © 2025, Infinite, All Rights Reserved.
        </p>
      </div>
    </footer>
  );
