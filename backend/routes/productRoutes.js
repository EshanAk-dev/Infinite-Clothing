...
// @desc Retrive least 8 products by creation date
// @access Public
...
// @desc Retrieve similar products by current product's gender and category
// @access Public
router.get("/similar/:id", async (req, res) => {
  ...
  try {
    ...
    const similarProducts = await Product.find({
      _id: { $ne: id }, // Exclude the current product from similar products
